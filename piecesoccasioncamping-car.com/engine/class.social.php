...
class Social
{
	...
	function getSocialBoxNormal()
	{
		...
		//$google_page_url = $this->getConfig("googleplus_page_url");
		...
		/*if($google_page_url != '')
		{
			$data .= '<a href="'.$google_page_url.'" target="newpage">'."\n";
			$data .= '<div class="social-box-container">'."\n";
			$data .= '<img src="'.$url_script.'/images/googleplus.png" alt="Visiter notre page Google+">'."\n";
			$data .= '</div>'."\n";
			$data .= '</a>'."\n";
		}*/
