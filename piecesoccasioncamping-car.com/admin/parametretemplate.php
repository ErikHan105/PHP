	...
	<div class="container">
		...
		<div class="filigrane-box">
			...
			<div class="fillgrane-place-box">
				...
				{
					?>
					<img src="preloadfiligrane.php?pourcent=<?php echo $pourcent_filigrane; ?>&position=<?php echo $position_filigrane; ?>" id="filigrane">
					<?php
				}
				?>
				</div>
		...
		function modifFiligrane()
		{
			...
			$('#filigrane').attr('src','preloadfiligrane.php?pourcent='+pourcent+'&position='+position+'&activer='+activer);
		}
