<?php
$host = "localhost";$user = "alloyyrr_pieceoccazcampingcar";$password = "!6hdWjM}4ez@";$dbname = "alloyyrr_pieceoccazcampingcar";
$url_script = "https://www.piecesoccasioncamping-car.com";$prefix = "pas_";
$demo = false;$debug_mode = false;
if($debug_mode){	ini_set('display_startup_errors',1);	ini_set('display_errors',1);	error_reporting(-1);}else{	ini_set('display_startup_errors',0);	ini_set('display_errors',0);	error_reporting(0);}
if($demo){	$upload_path = "/clone/pas";}else{	$upload_path = "";}
try
{
