...
if($type_account == 'professionel')
{
	...
	else
	{
		...
		if($compte_pro_type_paiement == 'paiement_unique')
		{
			...
			$SQL = "INSERT INTO pas_user (email,username,password,date_inscription,optin,md5,validate_account,ban,type_compte) VALUES ('$email','$pseudo','$password',NOW(),'$optin','$md5','yes','no','particulier')";
			$pdo->query($SQL);
