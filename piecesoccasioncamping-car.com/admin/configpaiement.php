...
<body>
	...
	<div class="container">
		...
		<div style="overflow:auto;">
			<div class="help-video-container" id="help-video-1" style="display:none;">
				<video width="400" height="222" controls="controls">
				  <source src="https://www.shua-creation.com/video/pas_script_configuration_paypal.mp4" type="video/mp4" />
				</video>
			</div>
		</div>
		<script>
		...
		<p>
		Stripe est un système de paiement qui vous permettra de faire payer vos utilisateurs par carte Bancaire, contrairement à Paypal, le paiement s'effectue uniquement par Carte Bancaire et les numéros de carte sont demandés directement
		sans aucune redirection, leur système est 100% sécurisé, l'inscription est totalement gratuite, sur chaque transaction est prélevé 2.9% + 0.30 € (en comission). Vous pouvez effectuer des demandes de virement depuis votre compte Stripe où ils seront automatiquement reversés sur votre compte bancaire sous 7 jours. Pour vous inscrire <br><br><a href="http://www.stripe.com" class="btn blue" target="newpage">Créer un compte Stripe</a><br><br>
		</p>
		<form>
		<?php
		...
		?>
		<label><b>Stripe API Publishable Key :</b></label>
		<input type="text" name="stripe_publishable_key" placeholder="Entrer la publishable key stripe" value="<?php echo getConfig("stripe_publishable_key"); ?>" class="inputbox">
		<label><b>Stripe API Secret Key :</b></label>
		<input type="text" name="stripe_secret_key" placeholder="Entrer la publishable key stripe" value="<?php echo getConfig("stripe_secret_key"); ?>" class="inputbox">
		<input type="hidden" name="action" value="2">
		<input type="submit" value="Modifier" class="btn blue">
		</form>
		<hr>
		<H2><img src="images/mobile-money-icon.png"> Mobicash</H2>
		<p>
		Mobicash est un service de paiement par Mobile money déployer dans de nombreux pays africain. Ce module permettra à vos client de régler leur annonce et leur options. Toute les transactions
		s'effectue de manière manuelle de se fait vous recevrez des paiements Mobicash et vous devrez valider les annonces manuellement après chaque paiement. Actuellement le module supporte les paiements
		mobicash du Burkina Faso, Mali
		</p>
		<form>
		<?php
		...
		{
			?>
			<input type="checkbox" name="mobicash_activate" value="yes" checked> <b>Activer les paiements Mobicash sur votre site internet</b><br><br>
			<?php
		}
		else
		{
			?>
			<input type="checkbox" name="mobicash_activate" value="yes"> <b>Activer les paiements Mobicash sur votre site internet</b><br><br>
			<?php
		}
		?>
			<label><b>Votre numéro de téléphone pour recevoir les paiements Mobicash</b></label>
