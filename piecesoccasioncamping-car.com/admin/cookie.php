...
if(isset($_REQUEST['action']))
{
	...
	if($action == 1)
	{
		$position_cookie = $_REQUEST['position_cookie'];
		updateConfig("position_cookie",$position_cookie);
		
		$policy_link_cookie = $_REQUEST['policy_link_cookie'];
		updateConfig("policy_link_cookie",$policy_link_cookie);
		
		$message_cookie = $_REQUEST['message_cookie'];
		updateConfig("message_cookie",$message_cookie);
		
		$policy_link_text_cookie = $_REQUEST['policy_link_text_cookie'];
		updateConfig("policy_link_text_cookie",$policy_link_text_cookie);
		
		$allow_button_cookie = $_REQUEST['allow_button_cookie'];
		updateConfig("allow_button_cookie",$allow_button_cookie);
		
		$layout_cookie = $_REQUEST['layout_cookie'];
		updateConfig("layout_cookie",$layout_cookie);
		
		$dissmiss_cookie = $_REQUEST['dissmiss_cookie'];
		updateConfig("dissmiss_cookie",$dissmiss_cookie);
		
		$palette_color_cookie = $_REQUEST['palette_color_cookie'];
		updateConfig("palette_color_cookie",$palette_color_cookie);
		
		$cookie_activer = $_REQUEST['cookie_activer'];
