...
if($categorie == 0)
{
	$titleAnnonce = 'Boutique Professionel';
}
else
{
	...
	$titleAnnonce = 'Boutique '.$req['titre'];
}
...
if($count == 0)
{
	...
	$block_resultat .= '<H2>Aucune boutiques pour le moment</H2>'."\n";
	$block_resultat .= '</div>'."\n";
}
else
{
	...
	for($x=0;$x<count($array);$x++)
	{
		...
		$itemOffre->assign("{nbr_annonce}",'<b>'.$count.' annonces</b>');
