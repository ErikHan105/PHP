...
if(isset($_REQUEST['action']))
{
	...
	if($action == 1)
	{
		...
		$SQL = "INSERT INTO pas_annonce (iduser,idregion,md5,titre,texte,offre_demande,idcategorie,prix,codepostal,valider,date_soumission,nbr_vue,telephone,ville,urgente,quinzejour,unmois,status) VALUES ($user,$region,'$md5','$titre','$texte','$type_annonce',$categorie,'$prix','$codepostal','$valider',NOW(),0,'$telephone','$ville','$urgente','$quinzejour','$trentejour','FREE')";
		$pdo->query($SQL);
	...
	<div class="container">
		...
		<form method="POST" enctype="multipart/form-data">
			...
			while($req = $reponse->fetch())
			{
				...
				{
				?>
				<option value="<?php echo $req['id']; ?>" disabled style="background-color:#aaaaaa;color:#ffffff;"><?php echo $req['titre']; ?></option>
				<?php
				}
				else
				{
			...
			<label><b>Type de remonter :</b></label><br><br>
			<input type="checkbox" name="urgente" value="1"> Urgente<br>
			<input type="checkbox" name="15jour" value="yes"> Remonter 15 jours<br>
			<input type="checkbox" name="30jour" value="yes"> Remonter 30 jours<br><br>
