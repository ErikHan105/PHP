...
.number-box
{
	...
	<div class="container">
		...
		<div style="float:right;margin-top: -120px;">
			<input type="text" style="height: 30px;margin-right: 5px;padding-left: 5px;border: 1px solid #aaaaaa;" placeholder="JJ/MM/AAAA" id="datestat" value="<?php echo "$jour/$mois/$annee"; ?>"><button class="btn" onclick="updateDate();">Rechercher</button>
		</div>
